...
const HomeContent = () => {
    ...
    return(
        <>
            <section className={'bg-secondColor ml-8 h-[427px]'} id={'about'}>
            ...
            <section className={'bg-secondColor mt-4 ml-8 flex flex-wrap'} id={'skills'}>
            ...
            <section className={'bg-secondColor mt-4 ml-8'} id={'experience'}>
            ...
            <section className={'bg-secondColor mt-4 ml-8 pb-10'}  id={'blog'}>
            ...
            <section className={'bg-secondColor mt-4 ml-8'}  id={'contacts'}>
