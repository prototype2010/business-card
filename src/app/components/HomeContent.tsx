    ...
    return(
        <>
            <section className={'bg-secondColor lg:ml-8 lg:h-[427px]'} id={'about'}>
                <h1 className={'text-white font-bold text-2xl lg:ml-16 ml-6 pt-8 font-serif'}>ABOUT ME</h1>
                <p className={'text-white font-bold lg:mx-16 mt-8 text-xl lg:px-13 mx-6'}>Hello, I’m Robert Smith</p>
                <p className={'text-white font-thin lg:mx-16 mt-8 text-xl lg:px-13 mx-6'}>Hello! I’m Robert Smith. Senior Web Developer specializing in front end development.
            ...
            <section className={'bg-secondColor lg:mt-4 lg:ml-8 lg:flex flex-wrap'} id={'skills'}>
                <div className={'lg:flex-initial lg:w-1/2 lg:mt-8 pl-6 lg:pl-16'}>
                    <h3 className={'text-gray-500 font-bold text-xl lg:pt-0 pt-10'}>personal information</h3>
                ...
                <div className={'flex-initial w-1/2 mt-8 pl-6'}>
                    ...
                    <div className={'text-white mt-8'}>
                        ...
                        <div className={'flex'}>
                            ...
                            <span className={'text-gray-500 ml-6'}>native</span>
                        </div>
                    </div>
                    ...
                    <div className={'text-white mt-4 h-32'}>
                        ...
                        <div className={'flex'}>
                            ...
                            <span className={'text-gray-500 ml-6'}>fluent</span>
                        </div>
                    </div>
                </div>
                <hr className={'border-1 border-gray-800 w-5/6 mx-auto mt-4'}/>
                <div className={'lg:flex-initial lg:w-1/2 mt-6 px-6 lg:pl-16'}>
                ...
                <div className={'lg:flex-initial lg:w-1/2 mt-6 pl-6'}>
                    <h3 className={'text-gray-500 font-bold text-xl'}>Professional Skills</h3>
                    <div className={'flex lg:flex-row lg:justify-center py-8 flex-col items-center'}>
                        <CircleProgressBar
                            progress={'95'}
                            svgSize={'100'}
                            name={'HTML & CSS'}/>
                ...
                <hr className={'border-1 border-gray-800 w-5/6 mx-auto mt-4'}/>
                <div className={'lg:flex-initial lg:w-1/2 mt-6 pl-6 lg:pl-16'}>
                ...
                <div className={'lg:flex-initial lg:w-1/2 mt-6 pl-6 pb-10'}>
            ...
            <section className={'bg-secondColor lg:mt-4 lg:ml-8'} id={'experience'}>
                <h2 className={'text-white font-bold text-2xl pt-8 pl-10'}>WORK EXPERIENCE</h2>
                <div>
                    <div className={'flex lg:pl-6 pl-2 pt-8'}>
                        ...
                        <div className={'pl-6 flex-initial w-3/4'}>
                            ...
                            <p className={'text-white pt-4 pr-2'}>Worked as part of a multi-disciplinary team, carrying out ad-hoc tasks as requested by the IT Manager. Had a specific brief to ensure the websites build for customer’s precisely matched their requirements.developers and marketers.</p>
                        </div>
                    </div>
                    <div className={'flex lg:pl-6 pl-2 pt-8'}>
                                  <span className={'flex-initial w-1/4 h-8 bg-mainColor text-center leading-8 '}>
                        ...
                        <div className={'mt-4 ml-3'}>
                            <div className={'w-1 h-1 bg-white rounded-full'}></div>
                            <div className={'lg:h-[123%] h-[115%] bg-mainColor w-[2px] ml-[1px]'}></div>
                        </div>
                        <div className={'pl-6 flex-initial w-3/4'}>
                            ...
                            <p className={'text-white pt-4 pr-2'}>Rebuilt and enhanced existing ASP B2C site with ASP.NET 2.0 Framework and tools. Technology consists of ASP.NET 2.0 (C#), IIS, Microsoft SQL Server 2005, Stored Procedures & PayPal Instant Payment Notification.</p>
                        </div>
                    </div>
                    <div className={'flex lg:pl-6 pl-1 pt-8 pb-12'}>
                                  <span className={'flex-initial w-1/4 h-8 bg-mainColor text-center leading-8 '}>
                                      <span className={'text-white'}>2009-2012</span>
                                  </span>
                        <div className={'w-0 h-0 border-t-[16px] border-t-transparent border-l-[14px] border-l-mainColor border-b-[16px] border-b-transparent'}></div>
                        <div className={'mt-4 lg:ml-3 ml-4'}>
                            <div className={'w-1 h-1 bg-white rounded-full'}></div>
                        </div>
                        <div className={'pl-6 flex-initial w-3/4'}>
                    ...
                    <div className={'pb-20'}>
                        ...
                        <div className={'flex lg:pl-6 pl-2 pt-8'}>
                                      <span className={'flex-initial lg:w-1/4 w-[100px] h-8 bg-mainColor text-center leading-8 '}>
                                          <span className={'text-white'}>2006-2008</span>
                                      </span>
                            <div className={'w-0 h-0 border-t-[16px] border-t-transparent border-l-[14px] border-l-mainColor border-b-[16px] border-b-transparent'}></div>
                            <div className={'mt-4 ml-3'}>
                                <div className={'w-1 h-1 bg-white rounded-full'}></div>
                                <div className={'lg:h-[230%] h-[170%] bg-mainColor w-[2px] ml-[1px]'}></div>
                            </div>
                            <div className={'pl-6 flex-initial w-3/4'}>
                        ...
                        <div className={'flex lg:pl-6 pt-8 pl-2'}>
                                      <span className={'flex-initial lg:w-1/4 w-[100px] h-8 bg-mainColor text-center leading-8 '}>
            ...
            <section className={'bg-secondColor lg:mt-4 lg:ml-8 pb-10'}>
                <h2 className={'text-white font-bold text-2xl pt-8 pl-10'}>CLIENTS</h2>
                <ul className={'lg:flex lg:flex-wrap lg:px-10 px-2 '}>
            ...
            <section className={'bg-secondColor lg:mt-4 lg:ml-8 pb-10'}>
                ...
                <div className={'mt-4'}>
                    <div className={'lg:ml-10 ml-4'}>
                        <button className={'text-gray-500 ml-6 text-xl font-bold hover:text-white lg:mr-8'}>All</button>
                        <button className={'text-gray-500 ml-6 text-xl font-bold hover:text-white lg:mr-8'}>Design</button>
                        <button className={'text-gray-500 ml-6 text-xl font-bold hover:text-white lg:mr-8'}>Team</button>
                        <button className={'text-gray-500 ml-6 text-xl font-bold hover:text-white lg:mr-8'}>Work</button>
                    </div>
            ...
            <section className={'bg-secondColor lg:mt-4 lg:ml-8 pb-10'}>
                ...
                <div className={'mt-4 lg:flex lg:flex-wrap block'}>
                    <div className={'flex lg:w-1/4 w-1/2 mt-6 ml-10'}>
            ...
            <section className={'bg-secondColor lg:mt-4 lg:ml-8 pb-10'}  id={'blog'}>
            ...
            <section className={'bg-secondColor lg:mt-4 lg:ml-8'}  id={'contacts'}>
