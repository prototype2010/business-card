...
const NavScrollBar = () => {
    ...
    return(
        <nav className={'w-[46px] h-[362px] ml-2 text-white sticky top-0 visible invisible lg:visible'}>
            <div>
                <ul className={'space-y-8'} onClick={(e) => scrollContent(e)} >
                    <li className={'flex group/item'}>
                        ...
                        <div className={'relative my-auto flex top-[12px] left-0 ml-1 invisible group-hover/item:visible'}>
                            <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-secondColor border-b-[8px] border-b-transparent my-auto'}></div>
                            <button className={'w-[65px] h-[30px] bg-secondColor rounded-lg text-white'}>About</button>
                        </div>
                    </li>
                    <li className={'group/item'} >
                        <div className={'flex'}>
                            ...
                            <div className={'relative my-auto flex top-0 left-0 ml-1 invisible group-hover/item:visible'}>
                                <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-secondColor border-b-[8px] border-b-transparent my-auto'}></div>
                                <button className={'w-[65px] h-[30px] bg-secondColor rounded-lg text-white'}>Skills</button>
                            </div>
                        </div>
                    </li>
                    <li className={'group/item'}>
                        <div className={'flex'}>
                            ...
                            <div className={'relative my-auto flex top-0 left-0 ml-1 invisible group-hover/item:visible'}>
                                <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-secondColor border-b-[8px] border-b-transparent my-auto'}></div>
                                <button className={'w-[100%] h-[30px] bg-secondColor rounded-lg text-white px-2'}>Experience</button>
                            </div>
                        </div>
                    </li>
                    <li className={'group/item'}>
                        <div className={'flex'}>
                            <div>
                                ...
                                <div className={'relative my-auto flex top-0 left-0 ml-1 invisible group-hover/item:visible'}>
                                    <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-secondColor border-b-[8px] border-b-transparent my-auto'}></div>
                                    <button className={'w-[100%] h-[30px] bg-secondColor rounded-lg text-white px-2'}>References</button>
                                </div>
                        </div>
                    </li>
                    <li className={'group/item'}>
                        <div className={'flex'}>
                            <div>
                                <svg data-scroll={'blog'} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 hover:opacity-60 cursor-pointer">
                                    <path ata-scroll={'blog'} strokeLinecap={'round'} strokeLinejoin="round"
                                          d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z"/>
                                </svg>
                            </div>
                                <div className={'relative my-auto flex top-0 left-0 ml-1 invisible group-hover/item:visible'}>
                                    <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-secondColor border-b-[8px] border-b-transparent my-auto'}></div>
                                    <button className={'w-[100%] h-[30px] bg-secondColor rounded-lg text-white px-2'}>Blog</button>
                                </div>
                        </div>
                    </li>
                    <li className={'group/item'}>
                        <div className={'flex'}>
                            <div className={'flex'}>
                                <div>
                                    ...
                                    <div className={'relative my-auto flex top-0 left-0 ml-1 invisible group-hover/item:visible'}>
                                        <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-secondColor border-b-[8px] border-b-transparent my-auto'}></div>
                                        <button className={'w-[100%] h-[30px] bg-secondColor rounded-lg text-white px-2'}>Contacts</button>
                                    </div>
                            </div>
                        </div>
                    </li>
