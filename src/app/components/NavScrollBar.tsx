                ...
                <ul className={'space-y-8 '} onClick={(e) => scrollContent(e)} >
                    <li className={'flex group/item'}>
                        <div className={'flex'}>
                            ...
                            <div className={'relative my-auto flex top-[12px] right-32 ml-1 invisible rotate-180 group-hover/item:visible xxl:rotate-0 xxl:left-0'}>
                    ...
                    <li className={'group/item'} >
                        <div className={'flex'}>
                            ...
                            <div className={'relative my-auto flex top-0 right-[120px] ml-1 invisible rotate-180 group-hover/item:visible xxl:rotate-0 xxl:left-0'}>
                                <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-gray-800 border-b-[8px] border-b-transparent my-auto'}></div>
                    ...
                    <li className={'group/item'}>
                        <div className={'flex'}>
                            ...
                            <div className={'relative my-auto flex top-0 right-[155px] rotate-180 ml-1 invisible group-hover/item:visible xxl:rotate-0 xxl:left-0'}>
                                <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-gray-800 border-b-[8px] border-b-transparent my-auto'}></div>
                    ...
                    <li className={'group/item'}>
                        <div className={'flex'}>
                            ...
                            <div className={'relative my-auto flex top-0 right-[100px] rotate-180 ml-1 invisible group-hover/item:visible xxl:rotate-0 xxl:left-0'}>
                                <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-gray-800 border-b-[8px] border-b-transparent my-auto'}></div>
                    ...
                    <li className={'group/item'}>
                        <div className={'flex'}>
                            <div className={'flex'}>
                                ...
                                <div className={'relative my-auto flex top-0 right-[133px] rotate-180 ml-1 invisible group-hover/item:visible xxl:rotate-0 xxl:left-0'}>
                                    <div className={'border-t-[8px] border-t-transparent border-r-[7px] border-r-gray-800 border-b-[8px] border-b-transparent my-auto'}></div>
