...
export const faqs = [
    {
        ...
        text: 'Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet purus urna. Proin dictum fringilla eni' +
            ...
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet purus urna. Proin dictum fringilla eni' +
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet purus urna. Proin dictum fringilla eniconsectetur adipiscing elit. Aliquam sit amet purus urna. Proin dictum fringilla enim, sit amet suscipit dolor dictum in'
    },
    {
        id: 2,
      ...
      <>
          <header className={'h-4'}>
              <div className={'container mx-auto mt-10 flex'}>
                  <div className={'ml-10 flex-initial w-[50%]'}>
                      <span className={'text-lg hover:text-red-400 font-bold'}>Developer</span>
                  </div>
          ...
          <div className={'container mx-auto'}>
              <div className={'flex'}>
                  <div className={'mt-8'}>
                      <div>
                          <div className={'ml-8 bg-mainColor w-[290px] h-[395px]'}>
                              <aside >
                              ...
                              <aside>
                                  ...
                                  <p className={'text-center font-bold mt-2 text-white italic'}>Frontend Developer</p>
                          ...
                          <div className={'ml-8 bg-secondColor w-[290px] h-[130px] text-center'} >
                              <button className={'bg-black text-white rounded-full text-xl mt-10 px-2 py-2'}>DOWNLOAD CV</button>
                          </div>
                      </div>
                  </div>
                              ...
                              <div className={'flex pt-6'}>
                                      <div className={'absolute text-white'}>
                                          <svg  className={'h-[80px] w-[80px]'} >
                                              <circle  cx="40" cy="40" r="30"  stroke="#1FA184" stroke-width="6" fill="#313C42" />
                                          </svg>
                                          <div className={'relative bottom-[54px] left-[24px] w-0'}>85%</div>
                                          <strong className={'w-4'}>HTML & CSS</strong>
                                      </div>
                              </div>
                          </div>
                          <hr className={'border-1 border-gray-800 w-5/6 mx-auto mt-4'}/>
                      ...
                      <section className={'bg-secondColor mt-4 ml-8'}>
                          ...
                          <div>
                              ...
                              <div className={'flex pl-6 pt-8'}>
                                  ...
                                  <div className={'mt-4 ml-4'}>
                                      <div className={'w-1 h-1 bg-white rounded-full'}></div>
                                      <div className={'h-[123%] bg-mainColor w-[2px] ml-[1px]'}></div>
                                  </div>
                                  <div className={'pl-6 flex-initial w-3/4'}>
                      ...
                      <section className={'bg-secondColor mt-4 ml-8 pb-10'}>
                          ...
                          <div className={'mt-4 flex flex-wrap'}>
                              <div className={'flex pl-10 w-1/3 mt-6'}>
                                  <svg className={'w-6 h-6 mr-4'} fill={'#1FA184'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M309.6 158.5L332.7 19.8C334.6 8.4 344.5 0 356.1 0c7.5 0 14.5 3.5 19 9.5L392 32h52.1c12.7 0 24.9 5.1 33.9 14.1L496 64h56c13.3 0 24 10.7 24 24v24c0 44.2-35.8 80-80 80H464 448 426.7l-5.1 30.5-112-64zM416 256.1L416 480c0 17.7-14.3 32-32 32H352c-17.7 0-32-14.3-32-32V364.8c-24 12.3-51.2 19.2-80 19.2s-56-6.9-80-19.2V480c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V249.8c-28.8-10.9-51.4-35.3-59.2-66.5L1 167.8c-4.3-17.1 6.1-34.5 23.3-38.8s34.5 6.1 38.8 23.3l3.9 15.5C70.5 182 83.3 192 98 192h30 16H303.8L416 256.1zM464 80a16 16 0 1 0 -32 0 16 16 0 1 0 32 0z"/></svg>
                                  <span className={'text-white text-xl'}>Animals</span>
                              </div>
                              <div className={'flex pl-10 w-1/3 mt-6'}>
                                  <svg className={'w-6 h-6 mr-4'} fill={'#1FA184'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M482.3 192c34.2 0 93.7 29 93.7 64c0 36-59.5 64-93.7 64l-116.6 0L265.2 495.9c-5.7 10-16.3 16.1-27.8 16.1l-56.2 0c-10.6 0-18.3-10.2-15.4-20.4l49-171.6L112 320 68.8 377.6c-3 4-7.8 6.4-12.8 6.4l-42 0c-7.8 0-14-6.3-14-14c0-1.3 .2-2.6 .5-3.9L32 256 .5 145.9c-.4-1.3-.5-2.6-.5-3.9c0-7.8 6.3-14 14-14l42 0c5 0 9.8 2.4 12.8 6.4L112 192l102.9 0-49-171.6C162.9 10.2 170.6 0 181.2 0l56.2 0c11.5 0 22.1 6.2 27.8 16.1L365.7 192l116.6 0z"/></svg>
                                  <span className={'text-white text-xl'}>Travel</span>
                              </div>
                              <div className={'flex pl-10 w-1/3 mt-6'}>
                                  <svg className={'w-6 h-6 mr-4'} fill={'#1FA184'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M312 32c-13.3 0-24 10.7-24 24s10.7 24 24 24h25.7l34.6 64H222.9l-27.4-38C191 99.7 183.7 96 176 96H120c-13.3 0-24 10.7-24 24s10.7 24 24 24h43.7l22.1 30.7-26.6 53.1c-10-2.5-20.5-3.8-31.2-3.8C57.3 224 0 281.3 0 352s57.3 128 128 128c65.3 0 119.1-48.9 127-112h49c8.5 0 16.3-4.5 20.7-11.8l84.8-143.5 21.7 40.1C402.4 276.3 384 312 384 352c0 70.7 57.3 128 128 128s128-57.3 128-128s-57.3-128-128-128c-13.5 0-26.5 2.1-38.7 6L375.4 48.8C369.8 38.4 359 32 347.2 32H312zM458.6 303.7l32.3 59.7c6.3 11.7 20.9 16 32.5 9.7s16-20.9 9.7-32.5l-32.3-59.7c3.6-.6 7.4-.9 11.2-.9c39.8 0 72 32.2 72 72s-32.2 72-72 72s-72-32.2-72-72c0-18.6 7-35.5 18.6-48.3zM133.2 368h65c-7.3 32.1-36 56-70.2 56c-39.8 0-72-32.2-72-72s32.2-72 72-72c1.7 0 3.4 .1 5.1 .2l-24.2 48.5c-9 18.1 4.1 39.4 24.3 39.4zm33.7-48l50.7-101.3 72.9 101.2-.1 .1H166.8zm90.6-128H365.9L317 274.8 257.4 192z"/></svg>
                                  <span className={'text-white text-xl'}>Bicycle</span>
                              </div>
                              <div className={'flex pl-10 w-1/3 mt-6'}>
                                  <svg className={'w-6 h-6 mr-4'} fill={'#1FA184'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M155.6 17.3C163 3 179.9-3.6 195 1.9L320 47.5l125-45.6c15.1-5.5 32 1.1 39.4 15.4l78.8 152.9c28.8 55.8 10.3 122.3-38.5 156.6L556.1 413l41-15c16.6-6 35 2.5 41 19.1s-2.5 35-19.1 41l-71.1 25.9L476.8 510c-16.6 6.1-35-2.5-41-19.1s2.5-35 19.1-41l41-15-31.3-86.2c-59.4 5.2-116.2-34-130-95.2L320 188.8l-14.6 64.7c-13.8 61.3-70.6 100.4-130 95.2l-31.3 86.2 41 15c16.6 6 25.2 24.4 19.1 41s-24.4 25.2-41 19.1L92.2 484.1 21.1 458.2c-16.6-6.1-25.2-24.4-19.1-41s24.4-25.2 41-19.1l41 15 31.3-86.2C66.5 292.5 48.1 226 76.9 170.2L155.6 17.3zm44 54.4l-27.2 52.8L261.6 157l13.1-57.9L199.6 71.7zm240.9 0L365.4 99.1 378.5 157l89.2-32.5L440.5 71.7z"/></svg>
                                  <span className={'text-white text-xl'}>Parties</span>
                              </div>
                              <div className={'flex pl-10 w-1/3 mt-6'}>
                                  <svg className={'w-6 h-6 mr-4'} fill={'#1FA184'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M234.7 42.7L197 56.8c-3 1.1-5 4-5 7.2s2 6.1 5 7.2l37.7 14.1L248.8 123c1.1 3 4 5 7.2 5s6.1-2 7.2-5l14.1-37.7L315 71.2c3-1.1 5-4 5-7.2s-2-6.1-5-7.2L277.3 42.7 263.2 5c-1.1-3-4-5-7.2-5s-6.1 2-7.2 5L234.7 42.7zM46.1 395.4c-18.7 18.7-18.7 49.1 0 67.9l34.6 34.6c18.7 18.7 49.1 18.7 67.9 0L529.9 116.5c18.7-18.7 18.7-49.1 0-67.9L495.3 14.1c-18.7-18.7-49.1-18.7-67.9 0L46.1 395.4zM484.6 82.6l-105 105-23.3-23.3 105-105 23.3 23.3zM7.5 117.2C3 118.9 0 123.2 0 128s3 9.1 7.5 10.8L64 160l21.2 56.5c1.7 4.5 6 7.5 10.8 7.5s9.1-3 10.8-7.5L128 160l56.5-21.2c4.5-1.7 7.5-6 7.5-10.8s-3-9.1-7.5-10.8L128 96 106.8 39.5C105.1 35 100.8 32 96 32s-9.1 3-10.8 7.5L64 96 7.5 117.2zm352 256c-4.5 1.7-7.5 6-7.5 10.8s3 9.1 7.5 10.8L416 416l21.2 56.5c1.7 4.5 6 7.5 10.8 7.5s9.1-3 10.8-7.5L480 416l56.5-21.2c4.5-1.7 7.5-6 7.5-10.8s-3-9.1-7.5-10.8L480 352l-21.2-56.5c-1.7-4.5-6-7.5-10.8-7.5s-9.1 3-10.8 7.5L416 352l-56.5 21.2z"/></svg>
                                  <span className={'text-white text-xl'}>Harry Potter</span>
                              </div>
                              <div className={'flex pl-10 w-1/3 mt-6'}>
                                  <svg className={'w-6 h-6 mr-4'} fill={'#1FA184'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M96 64c0-17.7 14.3-32 32-32H448h64c70.7 0 128 57.3 128 128s-57.3 128-128 128H480c0 53-43 96-96 96H192c-53 0-96-43-96-96V64zM480 224h32c35.3 0 64-28.7 64-64s-28.7-64-64-64H480V224zM32 416H544c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32z"/></svg>
                  ...
                  <div>
                      <nav className={'mt-12 w-[46px] h-[362px] ml-4'}>
                          <div>
          ...
          {/*<svg className={'hidden-sm hidden-xs h-[519px] w-[758px] '}>*/}
          {/*    <polygon points={'0,455,693,352,173,0,92,0,0,71'}></polygon>*/}
          {/*</svg>*/}
          {/*<svg className={'hidden-sm hidden-xs h-[536px] w-[633px]'}>*/}
